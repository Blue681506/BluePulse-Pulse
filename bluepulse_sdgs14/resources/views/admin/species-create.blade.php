...
<head>
    ...
    <title>Tambah Spesies - BluePulse</title>
...
<div class="ocean">
    ...
    <div class="header">
        <h1>🐠 Tambah Spesies Laut</h1>
        <p>Tambahkan data spesies laut ke Marine Encyclopedia BluePulse.</p>
    </div>
    ...
    <form action="{{ route('admin.species.store') }}"
        ...
        <a href="/admin/species" class="btn">
            Kembali
        </a>
